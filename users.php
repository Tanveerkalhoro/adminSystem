...
if(isset($is_submit) && $is_submit=="Y"){
    ...
    if(empty($error)){
        if($mode=="edit"){
            ...
            $sql2     = "SELECT * FROM users WHERE user_name='$user_name' AND full_name='$full_name' AND email='$email' ";
            $result2  =mysqli_query($conn,$sql2);
            $count2   =mysqli_num_rows($result2);
            if($count2 > 0) {
                    $error = "Sorry ! This record is already exist.";
            } else {
                $sql1  ="INSERT INTO users(full_name,user_name,email,pasword,role_id) values('$full_name','$user_name','$email','$pasword','$role_id')";
                $result1 =mysqli_query($conn,$sql1);
                if($result1 > 0){
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="users.php?menu_id=<?php echo $menu_id;?>&mode=edit&id=<?php echo $id?>">Edit</a> &nbsp;&nbsp;
                            <a href="users.php?menu_id=<?php echo $menu_id;?>&mode=delete&id=<?php echo $id?>">Delete</a>
                        </td>                    
                    </tr>
                    <?php
                            $i++;
